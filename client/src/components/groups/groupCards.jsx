...
import { Card, CardContent, Typography, Box, AvatarGroup, Avatar, Stack, Grid, IconButton } from '@mui/material';
...
export default function GroupCards({ title, description, groupMembers, share, currencyType, groupCategory, isGroupActive, onDelete, icon, color = 'primary', sx, ...other }) {
  return (
    <Card
      sx={{
        p: 0,
    ...
    >
      ...
      <Box pt={6} px={2} pb={3}
        sx={{
          bgcolor: (theme) => theme.palette[color].ligh,
          position: 'relative'
        }}
      >
        <IconButton
